  ...
  return (
    <Container show={showFilters}>
      ...
      <Row>
        ...
        <FilterOption>
          <LabelFlex>Edm QC:</LabelFlex>
          <ContainerInput>
            <Select
              id="select-ingestEdm"
              defaultValue={formValues.ingestEdm}
              onChange={(e) => {
                e.persist();
                updateFilter({
                  filterKey: "ingestEdm",
                  filterName: "Edm QC",
                  value: e.target.value,
                  valueLabel: e.target.value === "true" ? "YES" : "NO",
                });
                setFormValues((prev) => ({
                  ...prev,
                  ingestEdm: e.target.value,
                }));
              }}
              options={edmQcOptions}
            />
          </ContainerInput>
        </FilterOption>
        <FilterOption>
          <LabelFlex>Edition:</LabelFlex>
          <ContainerInput>
            <MultiSelect
...
const CancelIcon = styled.div`
  ...
  color: #d53737;
`;
export default TaskIngestEdmFilter;